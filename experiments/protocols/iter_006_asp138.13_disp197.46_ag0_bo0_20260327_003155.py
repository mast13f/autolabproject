"""
AutoLab Experiment Protocol — Iteration 6
=====================================================
Generated : 2026-03-27 00:31:55
Parameters: {'aspirate_speed': 138.13, 'dispense_speed': 197.46, 'air_gap': 0, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 6 — asp138.13_disp197.46_ag0_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=6 | asp=138.13 disp=197.46 ag=0 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 138.13   # µL/s
DISPENSE_SPEED = 197.46   # µL/s
