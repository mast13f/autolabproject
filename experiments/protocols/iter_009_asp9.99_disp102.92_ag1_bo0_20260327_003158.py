"""
AutoLab Experiment Protocol — Iteration 9
=====================================================
Generated : 2026-03-27 00:31:58
Parameters: {'aspirate_speed': 9.99, 'dispense_speed': 102.92, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 9 — asp9.99_disp102.92_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=9 | asp=9.99 disp=102.92 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 9.99   # µL/s
DISPENSE_SPEED = 102.92   # µL/s
