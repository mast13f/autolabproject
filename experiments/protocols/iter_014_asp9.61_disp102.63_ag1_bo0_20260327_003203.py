"""
AutoLab Experiment Protocol — Iteration 14
=====================================================
Generated : 2026-03-27 00:32:03
Parameters: {'aspirate_speed': 9.61, 'dispense_speed': 102.63, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 14 — asp9.61_disp102.63_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=14 | asp=9.61 disp=102.63 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 9.61   # µL/s
DISPENSE_SPEED = 102.63   # µL/s
