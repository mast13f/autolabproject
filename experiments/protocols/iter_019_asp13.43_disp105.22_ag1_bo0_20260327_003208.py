"""
AutoLab Experiment Protocol — Iteration 19
=====================================================
Generated : 2026-03-27 00:32:08
Parameters: {'aspirate_speed': 13.43, 'dispense_speed': 105.22, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 19 — asp13.43_disp105.22_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=19 | asp=13.43 disp=105.22 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 13.43   # µL/s
DISPENSE_SPEED = 105.22   # µL/s
