"""
AutoLab Experiment Protocol — Iteration 15
=====================================================
Generated : 2026-03-27 00:32:04
Parameters: {'aspirate_speed': 8.46, 'dispense_speed': 101.8, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 15 — asp8.46_disp101.8_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=15 | asp=8.46 disp=101.8 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 8.46   # µL/s
DISPENSE_SPEED = 101.8   # µL/s
