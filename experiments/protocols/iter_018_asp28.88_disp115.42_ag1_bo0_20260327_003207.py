"""
AutoLab Experiment Protocol — Iteration 18
=====================================================
Generated : 2026-03-27 00:32:07
Parameters: {'aspirate_speed': 28.88, 'dispense_speed': 115.42, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 18 — asp28.88_disp115.42_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=18 | asp=28.88 disp=115.42 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 28.88   # µL/s
DISPENSE_SPEED = 115.42   # µL/s
