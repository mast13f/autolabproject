"""
AutoLab Experiment Protocol — Iteration 1
=====================================================
Generated : 2026-03-27 00:31:51
Parameters: {'aspirate_speed': 76.85, 'dispense_speed': 41.77, 'air_gap': 0, 'blow_out': 1}
...
metadata = {
    "protocolName": "AutoLab Iter 1 — asp76.85_disp41.77_ag0_bo1",
    "author": "AutoLab Experiment Runner",
    "description": "iter=1 | asp=76.85 disp=41.77 ag=0 bo=1",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 76.85   # µL/s
DISPENSE_SPEED = 41.77   # µL/s
