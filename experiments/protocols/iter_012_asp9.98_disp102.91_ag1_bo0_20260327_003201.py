"""
AutoLab Experiment Protocol — Iteration 12
=====================================================
Generated : 2026-03-27 00:32:01
Parameters: {'aspirate_speed': 9.98, 'dispense_speed': 102.91, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 12 — asp9.98_disp102.91_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=12 | asp=9.98 disp=102.91 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 9.98   # µL/s
DISPENSE_SPEED = 102.91   # µL/s
