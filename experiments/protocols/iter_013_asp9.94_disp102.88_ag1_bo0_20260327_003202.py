"""
AutoLab Experiment Protocol — Iteration 13
=====================================================
Generated : 2026-03-27 00:32:02
Parameters: {'aspirate_speed': 9.94, 'dispense_speed': 102.88, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 13 — asp9.94_disp102.88_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=13 | asp=9.94 disp=102.88 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 9.94   # µL/s
DISPENSE_SPEED = 102.88   # µL/s
