"""
AutoLab Experiment Protocol — Iteration 16
=====================================================
Generated : 2026-03-27 00:32:05
Parameters: {'aspirate_speed': 4.81, 'dispense_speed': 99.27, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 16 — asp4.81_disp99.27_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=16 | asp=4.81 disp=99.27 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 4.81   # µL/s
DISPENSE_SPEED = 99.27   # µL/s
