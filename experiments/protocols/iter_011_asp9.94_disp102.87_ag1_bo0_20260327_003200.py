...
=====================================================
Generated : 2026-03-27 00:32:00
Parameters: {'aspirate_speed': 9.94, 'dispense_speed': 102.87, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 11 — asp9.94_disp102.87_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=11 | asp=9.94 disp=102.87 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 9.94   # µL/s
DISPENSE_SPEED = 102.87   # µL/s
