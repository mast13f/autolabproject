"""
AutoLab Experiment Protocol — Iteration 2
=====================================================
Generated : 2026-03-27 00:31:51
Parameters: {'aspirate_speed': 115.3, 'dispense_speed': 22.87, 'air_gap': 0, 'blow_out': 1}
...
metadata = {
    "protocolName": "AutoLab Iter 2 — asp115.3_disp22.87_ag0_bo1",
    "author": "AutoLab Experiment Runner",
    "description": "iter=2 | asp=115.3 disp=22.87 ag=0 bo=1",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 115.3   # µL/s
DISPENSE_SPEED = 22.87   # µL/s
AIR_GAP        = False         # add 2 µL air gap after aspirate
BLOW_OUT       = True        # blow out at destination after dispense
