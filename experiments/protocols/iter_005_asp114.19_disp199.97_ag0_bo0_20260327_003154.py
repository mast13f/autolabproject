"""
AutoLab Experiment Protocol — Iteration 5
=====================================================
Generated : 2026-03-27 00:31:54
Parameters: {'aspirate_speed': 114.19, 'dispense_speed': 199.97, 'air_gap': 0, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 5 — asp114.19_disp199.97_ag0_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=5 | asp=114.19 disp=199.97 ag=0 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 114.19   # µL/s
DISPENSE_SPEED = 199.97   # µL/s
