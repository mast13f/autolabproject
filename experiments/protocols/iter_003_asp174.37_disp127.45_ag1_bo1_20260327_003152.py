"""
AutoLab Experiment Protocol — Iteration 3
=====================================================
Generated : 2026-03-27 00:31:52
Parameters: {'aspirate_speed': 174.37, 'dispense_speed': 127.45, 'air_gap': 1, 'blow_out': 1}
...
metadata = {
    "protocolName": "AutoLab Iter 3 — asp174.37_disp127.45_ag1_bo1",
    "author": "AutoLab Experiment Runner",
    "description": "iter=3 | asp=174.37 disp=127.45 ag=1 bo=1",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 174.37   # µL/s
DISPENSE_SPEED = 127.45   # µL/s
