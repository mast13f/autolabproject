"""
AutoLab Experiment Protocol — Iteration 11
=====================================================
Generated : 2026-03-27 00:47:27
Parameters: {'blow_out': 1, 'aspirate_speed': 200, 'dispense_speed': 100.5, 'air_gap': 1}
...
metadata = {
    "protocolName": "AutoLab Iter 11 — bo1_asp200_disp100.5_ag1",
    "author": "AutoLab Experiment Runner",
    "description": "iter=11 | asp=200.0 disp=100.5 ag=1 bo=1",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 200.0   # µL/s
DISPENSE_SPEED = 100.5   # µL/s
