"""
AutoLab Experiment Protocol — Iteration 17
=====================================================
Generated : 2026-03-27 00:32:06
Parameters: {'aspirate_speed': 13.74, 'dispense_speed': 105.42, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 17 — asp13.74_disp105.42_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=17 | asp=13.74 disp=105.42 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 13.74   # µL/s
DISPENSE_SPEED = 105.42   # µL/s
