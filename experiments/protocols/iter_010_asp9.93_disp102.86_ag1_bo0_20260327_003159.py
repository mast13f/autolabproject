"""
AutoLab Experiment Protocol — Iteration 10
=====================================================
Generated : 2026-03-27 00:31:59
Parameters: {'aspirate_speed': 9.93, 'dispense_speed': 102.86, 'air_gap': 1, 'blow_out': 0}
...
metadata = {
    "protocolName": "AutoLab Iter 10 — asp9.93_disp102.86_ag1_bo0",
    "author": "AutoLab Experiment Runner",
    "description": "iter=10 | asp=9.93 disp=102.86 ag=1 bo=0",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.18"}

# ── Optimized parameters (set by Bayesian optimizer) ─────────────────────────
ASPIRATE_SPEED = 9.93   # µL/s
DISPENSE_SPEED = 102.86   # µL/s
